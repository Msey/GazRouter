...
{
    public class SetPropertyValueCommand : CommandNonQuery<SetPropertyValueParameterSet>
    {
        public SetPropertyValueCommand(ExecutionContext context)
            : base(context)
        {
        ...
        protected override void BindParameters(OracleCommand command, SetPropertyValueParameterSet parameters)
        {
            ...
            command.AddInputParameter("p_source_type", 5);
