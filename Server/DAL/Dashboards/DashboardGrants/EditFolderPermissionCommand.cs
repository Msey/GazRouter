...
{
    public class EditFolderPermissionCommand : CommandNonQuery<DashboardPermissionParameterSet>
    {
        public EditFolderPermissionCommand(ExecutionContext context) : base(context)
        {
        ...
        {
             return @"P_FOLDER_PERMISSION.EDIT";
        }
    }
}
