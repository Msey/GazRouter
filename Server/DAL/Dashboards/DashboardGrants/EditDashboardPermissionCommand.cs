...
{
    public class EditDashboardPermissionCommand : CommandNonQuery<DashboardPermissionParameterSet>
    {
        public EditDashboardPermissionCommand(ExecutionContext context) : base(context)
		{
        ...
        {
            return @"P_DASHBOARD_PERMISSION.EDIT";
        }
    }
}
