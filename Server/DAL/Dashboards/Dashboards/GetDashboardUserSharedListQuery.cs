...
{
    public class GetDashboardUserSharedListQuery : QueryReader<int, List<DashboardDTO>>
    {
        public GetDashboardUserSharedListQuery(ExecutionContext context) : base(context){ }
