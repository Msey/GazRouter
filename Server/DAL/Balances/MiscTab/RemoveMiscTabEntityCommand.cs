...
{
    public class RemoveMiscTabEntityCommand : CommandNonQuery<AddRemoveMiscTabEntityParameterSet>
    {
        public RemoveMiscTabEntityCommand(ExecutionContext context) : base(context)
        {
        ...
        {
            return "P_BL_MISC_TAB_ENTITY.Remove";
        }
