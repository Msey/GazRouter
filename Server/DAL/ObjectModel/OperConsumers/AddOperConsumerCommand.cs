...
{
    public class AddOperConsumerCommand : CommandScalar<AddEditOperConsumerParameterSet, Guid>
    {
        public AddOperConsumerCommand(ExecutionContext context)
            : base(context)
        {
        ...
        {
            return "rd.P_OPER_CONSUMER.AddF";
        }
