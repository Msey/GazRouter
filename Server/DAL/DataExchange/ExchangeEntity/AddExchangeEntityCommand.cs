...
{
    public class AddExchangeEntityCommand : CommandNonQuery<AddEditExchangeEntityParameterSet>
    {
        public AddExchangeEntityCommand(ExecutionContext context)
            : base(context)
        {
        ...
        {
            return "rd.P_EXCHANGE_ENTITY.Add";
