...
{
    public class EditExchangeEntityCommand : CommandNonQuery<AddEditExchangeEntityParameterSet>
    {
        public EditExchangeEntityCommand(ExecutionContext context)
            : base(context)
        {
        ...
        {
            return "rd.P_EXCHANGE_ENTITY.Edit";
