...
namespace GazRouter.DAL.Repairs.Plan
{
    ...
    /// ДЛЯ КЦ
    /// </summary>
    public class GetPlanRepairListForCompShopsQuery : QueryReader<GetRepairPlanParameterSet, List<RepairPlanBaseDTO>>
    {
        public GetPlanRepairListForCompShopsQuery(ExecutionContext context)
            : base(context)
        {
        }
