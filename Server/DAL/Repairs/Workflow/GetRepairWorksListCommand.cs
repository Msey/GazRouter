...
{
    public class GetWorkflowRepairWorkListQuery : QueryReader<int, Dictionary<int, List<RepairWorkDTO>>>
    {
        public GetWorkflowRepairWorkListQuery(ExecutionContext context)
            : base(context)
        {
        }
