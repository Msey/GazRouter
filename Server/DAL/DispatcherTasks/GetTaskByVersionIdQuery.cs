...
{
    public class GetTaskByVersionIdQuery : QueryReader<Guid, TaskDTO>
    {
        public GetTaskByVersionIdQuery(ExecutionContext context)
            : base(context)
        {
        }
        ...
        protected override string GetCommandText(Guid parameters)
        {
            return @"select t.task_id, t.task_number, t.subject, t.description, t.last_version_id,
                     ...
                     from v_tasks t
                     where t.last_version_id = :p1";
        }

        protected override TaskDTO GetResult(OracleDataReader reader, Guid parameters)
        {
