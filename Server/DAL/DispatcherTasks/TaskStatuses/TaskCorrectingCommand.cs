...
{
    public class TaskCorrectingCommand : CommandScalar<SetTaskStatusParameterSet, Guid>
    {
        public TaskCorrectingCommand(ExecutionContext context)
            : base(context)
        {
        ...
        {
            return "tasks.P_TASK.Set_CORRECTING";
        }
    }
}