...
{
    public class TaskSubmitedCommand : CommandScalar<SetTaskStatusParameterSet, Guid>
    {
		public TaskSubmitedCommand(ExecutionContext context)
            : base(context)
		{
        ...
        {
            return "tasks.P_TASK.SET_SUBMITTED";
        }
    }
}
