...
{
    public class TaskCorrectedCommand : CommandScalar<SetTaskStatusParameterSet, Guid>
    {
		public TaskCorrectedCommand(ExecutionContext context)
            : base(context)
		{
        ...
        {
            return "tasks.P_TASK.SET_CORRECTED";
        }
    }
}
