...
{
    public class GetActionsByRoleIdQuery : QueryReader<int, List<ActionDTO>>
    {
        public GetActionsByRoleIdQuery(ExecutionContext context)
            : base(context)
        {}
  ...
  from V_ROLEACTIONS t1 where t1.app_host_name = :p2 and role_id = :p1";
        }
