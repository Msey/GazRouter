...
namespace GazRouter.DAL.Authorization.Role
{
    ...
    public class AddRoleActionCommand : CommandNonQuery<RoleActionParameterSet>
	{
        public AddRoleActionCommand(ExecutionContext context) : base(context)
        {
	    ...
	    {
            return "P_ACTION.Add_ROLEACTION";
	    }
	}
