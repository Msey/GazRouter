...
{
    public class EditPipelineLimitStoryCommand : CommandNonQuery<AddPipelineLimitStoryParameterSet>
    {
        public EditPipelineLimitStoryCommand(ExecutionContext context)
            : base(context)
        {
        ...
        {
            return "rd.P_PIPELINE_LIMIT_STORY.Edit";
        }
    }
}
