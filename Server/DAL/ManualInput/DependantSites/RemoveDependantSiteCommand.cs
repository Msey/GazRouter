...
{
    public class RemoveDependantSiteCommand : CommandNonQuery<AddRemoveDependantSiteParameterSet>
    {
        public RemoveDependantSiteCommand(ExecutionContext context)
            : base(context)
        {
        ...
        {
            return "rd.P_INPUT_DEPENDANT_SITE.Remove";
        }
    }
}