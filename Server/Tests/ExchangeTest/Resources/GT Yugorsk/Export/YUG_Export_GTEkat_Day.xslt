...
<xsl:stylesheet version="2.0"
  ...
  <xsl:variable name="timestamp">
    <xsl:value-of select="format-dateTime(ExchangeMessage/HeaderSection/TimeStamp, '[Y0001][M01][D01]')" />
  </xsl:variable>
  ...
  <xsl:template match="ExchangeMessage/DataSection">
    ...
    <xsl:variable name="v_46" select="sum(DistributingStations/DistributingStation/Properties/Property[SysName='flow' and ExtKey != '32018']/Value)"/>
