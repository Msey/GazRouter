...
<xsl:stylesheet version='2.0' xmlns:xsl='http://www.w3.org/1999/XSL/Transform' xmlns:xs='http://www.w3.org/2001/XMLSchema'>
  ...
  <xsl:param name='inputContent' as='xs:string'   >01:	50.3	:2017090113	:P вых Сысконсынье ати
    02:	6.9	:2017090113	:T вых Сысконсынье градС
    03:	83.122	:2017090113	:Q тыс.м3/час
    04:	-31.5	:2017090113	:Т росы по воде град.Цельсия
    05:	-22.4	:2017090113	:Т росы по углеводороду град.Цельсия
    06:	70.4	:2017090113	:P вход. Сысконсынье ати
    07:	8	:2017090113	:Количество скважин
      ...
      <xsl:matching-substring>
        ...
        <xsl:choose>
          <xsl:when test="string($dt) castable as xs:dateTime">
            <xsl:value-of select="format-dateTime(xs:dateTime($dt) + xs:dayTimeDuration('PT1H'), '[Y0001]-[M01]-[D01]T[H01]:[m01]:[s01]')" />
          </xsl:when>
          <xsl:otherwise>
