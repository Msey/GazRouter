  ...
  <xsl:template match='ExchangeMessage'>
    <BusinessMessage>
      <HeaderSection>
        ...
        <Comment>Файл данных от ГТ Чайковский.  2-х часовой. Режимно-технологические параметры.</Comment>
        <ReferenceTime>
            <xsl:attribute name="time">
              <!--xsl:value-of select ='HeaderSection/TimeStamp'/-->
              <xsl:value-of select ="format-dateTime(HeaderSection/TimeStamp, '[Y0001]-[M01]-[D01]T10:00:00[Z]')"/>
            </xsl:attribute>
        </ReferenceTime>
        <Scale>PT2H</Scale>
        <Template id="T_CHA.PT2H.RT.V1"/>
        <FullName/>
      </HeaderSection>
