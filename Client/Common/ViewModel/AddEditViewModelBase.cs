...
{
    public abstract class AddEditViewModelBase<TEntity, TId> : DialogViewModel<Action<TId>> where TEntity : class, new()
    {
        private string _name;
        protected AddEditViewModelBase(Action<TId> closeCallback, TEntity model = null)
            : base(closeCallback)
        {
            _isEdit = model != null;
            _isAdd = !_isEdit;
