...
namespace GazRouter.DataProviders.Bindings  
{
    [ServiceContract]
	...
	public interface IBindingsServiceProxy
	{

        Task<List<BindingDTO>> GetEntityBindingsListAsync(GetEntityBindingsPageParameterSet parameters);

        Task<Guid> AddEntityBindingsAsync(EntityBindingParameterSet parameters);

        Task EditEntityBindingsAsync(EditEntityBindingParameterSet parameters);

        Task DeleteEntityBindingsAsync(Guid parameters);

        Task<List<EntityPropertyBindingDTO>> GetEntityPropertyBindingsListAsync(GetEntityPropertyBindingsParameterSet parameters);

        Task<Guid> AddEntityPropertyBindingsAsync(AddEntityPropertyBindingParameterSet parameters);

        Task EditEntityPropertyBindingsAsync(EditEntityPropertyBindingParameterSet parameters);

        Task DeleteEntityPropertyBindingsAsync(Guid parameters);

    }

    public sealed class BindingsServiceProxy : DataProviderBase<IBindingsService>, IBindingsServiceProxy
	{
        protected override string ServiceUri => "/Bindings/BindingsService.svc";
