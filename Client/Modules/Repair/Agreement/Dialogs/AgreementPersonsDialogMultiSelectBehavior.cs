...
{
    public class AgreementPersonsDialogMultiSelectBehavior : Behavior<RadGridView>
    {
        ...
        public static readonly DependencyProperty SelectedItemsProperty =
            DependencyProperty.Register("SelectedItems", typeof(INotifyCollectionChanged), typeof(AgreementPersonsDialogMultiSelectBehavior), new PropertyMetadata(OnSelectedItemsPropertyChanged));
        ...
        private static void OnSelectedItemsPropertyChanged(DependencyObject target, DependencyPropertyChangedEventArgs args)
        {
            ...
            if (collection != null)
            {
                collection.CollectionChanged += ((AgreementPersonsDialogMultiSelectBehavior)target).ContextSelectedItems_CollectionChanged;
            }
        }
