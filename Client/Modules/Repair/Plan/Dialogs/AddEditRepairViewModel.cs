...
namespace GazRouter.Repair.Plan.Dialogs
{
    public class AddEditRepairViewModel : AddEditViewModelBase<RepairPlanBaseDTO, int>
    {
        ...
        private DateTime? _dateStartSched;
        private DateTime? _dateEndSched;
        ...
        public DateTime? ResolutionDate
        {
            ...
            set { if (SetProperty(ref _resolutionDate, value)) OnPropertyChanged(() => ResolutionDate); }
        }
        private DateTime? _resolutionDateCpdd;
        public DateTime? ResolutionDateCpdd
        {
            get { return _resolutionDateCpdd; }
            set { if (SetProperty(ref _resolutionDateCpdd, value)) OnPropertyChanged(() => ResolutionDateCpdd); }
        }
        ...
        public string ResolutionNum
        {
            ...
            set { if (SetProperty(ref _resolutionNum, value)) OnPropertyChanged(() => ResolutionNum); }
        }
        private string _resolutionNumCpdd;
        public string ResolutionNumCpdd
        {
            get { return _resolutionNumCpdd; }
            set { if (SetProperty(ref _resolutionNumCpdd, value)) OnPropertyChanged(() => ResolutionNumCpdd); }
        }
            ...
            : base(actionBeforeClosing, repair)
        {
            ...
            SelectedFireType = FireTypeList.First(o => o.Firetype == repair.Firework );

            _dateStartFact = repair.DateStartFact;
            _dateEndFact = repair.DateEndFact;

            _dateStartSched = repair.DateStartSched;
            _dateEndSched = repair.DateEndSched;
            ...
            ProcessCommand = new DelegateCommand(ProcessWorks);
            ...
            if (repair.WFWState.WFState == WorkStateDTO.WorkflowStates.Undefined)
                AllowToProcess = true;
            else
            ...
            : base(actionBeforeClosing)
        {
            ...
            _dateStartSched = _startDate;
            _dateEndSched = _endDate;
        ...
        /// </summary>
        //public TimeSpan Duration => new DateTime(EndDate.Year, EndDate.Month, EndDate.Day, 18, 0, 0) - new DateTime(StartDate.Year, StartDate.Month, StartDate.Day, 8, 0, 0); //EndDate - StartDate;
        private void RecalcDuration()
        {
            try
            {
                if (Duration > Converters.DurationFromDates.TotalHours(StartDate, EndDate))
        ...
        private void SetValidationRules()
        {
            ...
            AddValidationFor(() => SelectedFireType)
                .When(() => SelectedFireType == null)
                .Show("На задан тип огневых работ");
        ...
        private FireworksDTO _selectedFireType;
        public FireworksDTO SelectedFireType
        {
            get { return _selectedFireType; }
            set
            {
                if (SetProperty(ref _selectedFireType, value))
                {
                    SaveCommand.RaiseCanExecuteChanged();
                }
                //_selectedFireType = value;
        ...
        protected override Task UpdateTask
        {
            get
            {
                var paramSet = new EditRepairParameterSet
                {
                    ...
                    DateStartShed = _dateStartSched,
                    DateEndShed = _dateEndSched,
        ...
        private bool _allowToProcess = false;
        public bool AllowToProcess
        {
            get
            { return _allowToProcess; }
            set
            {
                _allowToProcess = value;
                OnPropertyChanged(() => AllowToProcess);
            }
        }
        ...
        public void ProcessWorks()
        {
            RadWindow.Confirm(new DialogParameters
            {
                ...
                Content = "Подтвердите пожалуйста установку статуса \"" +
                    new WorkStateDTO() { WFState = WorkStateDTO.WorkflowStates.Draft, WState = WorkStateDTO.WorkStates.Undefined }.Name
            + "\"",
                Closed = async (o, even) =>
                {
                    if (even.DialogResult.HasValue && even.DialogResult.Value)
                    {
                        ...
                        {
                            Header = "Статус изменен",
                            Content = "Установлен статус \"" + new WorkStateDTO() { WFState = WorkStateDTO.WorkflowStates.Draft, WState = WorkStateDTO.WorkStates.Undefined }.Name + "\""
                        });
                    }
                }
            });
