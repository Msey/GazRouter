...
namespace GazRouter.Repair.Plan
{
    ...
    public class Repair : RepairBase
    {
        ...
        public static Repair Create(RepairPlanBaseDTO dto)
        {
            if (dto.EntityType == EntityType.Pipeline)
                return new PipelineRepair {Dto = dto};
            return new Repair {Dto = dto};
        }
        ...
        public TimeSpan DurationPlan => (Dto.Duration.HasValue && Dto.Duration.Value !=0) ? new TimeSpan(Dto.Duration.Value, 0, 0) : Dto.EndDate - Dto.StartDate;
    ...
    public class PipelineRepair : Repair { }
